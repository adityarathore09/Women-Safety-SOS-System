      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <p className="text-slate-500 text-[10px] font-mono uppercase tracking-[0.3em]">Security Protocol Active</p>
          </div>
        </div>

        <Card className="border-white/5 bg-[#0f0f0f]/80 backdrop-blur-xl shadow-2xl shadow-black overflow-hidden">
          <div className="h-1 w-full bg-gradient-to-r from-emerald-600 via-emerald-400 to-emerald-600 opacity-50" />
          <CardHeader className="space-y-1 p-8 pb-4">
            <CardTitle className="text-2xl font-bold text-white">Login Page</CardTitle>
            <CardDescription className="text-slate-500 font-mono text-[10px] uppercase tracking-widest">
              Enter credentials to establish secure uplink
            </CardDescription>
          </CardHeader>
